...
const UploadBillForm = ({ projectId, onClose, onSuccess }) => {
    ...
    const [form, setForm] = useState({
        ...
        amount: '',
        category: '',
        receiptUrl: 'https://images.unsplash.com/photo-1554224155-6726b3ff858f' // Mock receipt URL
    });
    ...
    const handleSubmit = async (e) => {
        ...
        // Basic Client-side check (Backend also checks)
    ...
    return (
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-300 bg-[#1c1c24] p-6 rounded-[20px] border border-[#3a3a43]">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-6 w-full">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <div className="border-2 border-dashed border-[#3a3a43] rounded-[10px] h-[150px] flex flex-col items-center justify-center cursor-pointer hover:border-[#8c6dfd] transition-colors bg-[#13131a]">
                        <Upload className="text-[#808191] mb-2" />
                        <span className="text-[#808191] text-sm">Drag or click to upload receipt</span>
                        <p className="text-[#4b5264] text-[10px] mt-2">Simulated for Hackathon</p>
                    </div>
                </div>
